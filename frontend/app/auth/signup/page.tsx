    ...
    <div className="container mx-auto px-4 py-16 flex items-center justify-center">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-2xl font-bold mt-6">Create Account</h1>
          <p className="text-sm text-muted-foreground mt-1">Join the Style Club today</p>
        </div>
        ...
        <p className="text-xs text-muted-foreground text-center mt-4 flex items-center justify-center gap-1.5">
          <Check className="h-3 w-3" /> By signing up, you agree to our Terms & Privacy Policy
        </p>
      </motion.div>
    </div>
  );
